...
func main() {
	...
	if err != nil {
		fmt.Println("https://www.facebook.com/trung.hai.62")
		os.Exit(1)
	}

	if version {
		fmt.Println("LTH", __version__)
		os.Exit(0)
	}
	...
	go func() {
		...
		fmt.Println("Add FB: https://www.facebook.com/trung.hai.62")
		for {
			if atomic.LoadInt32(&cur) < int32(maxproc-1) {
				go httpcall(site, u.Host, data, headers, ss)
			}
			if sent%10 == 0 {
				fmt.Printf("https://www.facebook.com/trung.hai.62", cur, maxproc, sent, err)
			}
			switch <-ss {
			case callExitOnErr:
